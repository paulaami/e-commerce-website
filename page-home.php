    ...
    <section id="about__section" class="about__section">
      ...
      <div class="about">
        ...
        <div class="about__me">
          ...
          Prowadzę treningi dla kobiet. Moim celem jest to, byś poznała i wysłuchała się w potrzeby własnego ciała. Zwolnij, odetchnij i daj sobie szanse na lepsze jutro…
          </p>
    ...
    <section class="opinion__section">
      ...
      <div class="opinion__section-container carousel">
        ...
        <div class="opinion__section-box">
          <div class="opinion__section-box-photo"><img class="opinion__section-box-img" src="<?php echo get_theme_file_uri('/assets/images/KarolinaS.jpg') ?>" alt="Zdjęcie podopiecznej Karoliny S."></div>
        ...
        <div class="opinion__section-box">
          <div class="opinion__section-box-photo"><img class="opinion__section-box-img" src="<?php echo get_theme_file_uri('/assets/images/ZofiaK.jpg') ?>" alt="Zdjęcie podopiecznej Zosi K."></div>
        ...
        <div class="opinion__section-box">
          <div class="opinion__section-box-photo photo-three"><img class="opinion__section-box-img" src="<?php echo get_theme_file_uri('/assets/images/PaulinaR.jpg') ?>" alt="Zdjęcie podopiecznej Pauliny R."></div>
      ...
      <div class="blog__list">
        ...
        <div class="blog__item">
          <div class="blog__item-photo">
            <img src="<?php echo get_theme_file_uri('/assets/images/Karolina-photo2.jpg') ?>" alt="Zdjęcie Karoliny podczas treningu" class="blog__item-img" />
          </div>
        ...
        <div class="blog__item">
          <div class="blog__item-photo">
            <img src="<?php echo get_theme_file_uri('/assets/images/zdrowy-posilek.jpg') ?>" alt="Zdjęcie posiłku Karoliny" class="blog__item-img" />
          </div>
        ...
        <div class="blog__item">
          <div class="blog__item-photo">
            <img src="<?php echo get_theme_file_uri('/assets/images/Karolina-photo1.jpg') ?>" alt="Motywujące zdjęcie Karoliny" class="blog__item-img" />
          </div>
